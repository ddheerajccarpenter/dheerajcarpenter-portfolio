  ...
  return (
    <div className="flex min-h-[60vh] flex-col items-center justify-center text-center px-6 py-24 space-y-6">
      <div className="p-4 bg-surface border border-border rounded-2xl shadow-xs">
        <AlertTriangle className="h-10 w-10 text-foreground opacity-80" />
      </div>
      <div className="space-y-2 max-w-[40ch]">
        <h1 className="text-h2 font-bold tracking-tight text-editorial-gradient">Something went wrong</h1>
